    ...
    <div class="container-fluid content">
      <div class="row pb-5">
        ...
        <div class="col-md-8 col-lg-6 col-xl-4">
          <img class="my-5" src="./assets/images/cat_light.gif" alt="dark" width="100%" height="auto">
          <input type="text" class="form-control search-box" placeholder="Type to search..." autocomplete="off" value="<?php echo $keywords; ?>">
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-lg-10 col-xl-8">
          <div class="container-fluid">
              ...
              ?>
                <div class="col-md-4 my-2">
                  <div class="box-container p-1 d-flex">
                    ...
                    <a href="<?php echo $row['url'];?>" target="_blank" class="item" onclick="save(<?php echo $row['app_id'];?>, <?php echo $row['name']?>)">
                      <div class="box position-relative w-100" style="height: 90px;">
                        <div class="top-border"></div>
                        <div class="d-flex">  
                          <div>
                            <img src="./assets/app_icons/<?php echo $row['icon_name'];?>.png" alt="png" style="width: 50px;" class="p-1">
                          </div>
                          <div class="w-100 px-1">
                            <h6 class="fw-bold my-1 item-title"><?php echo $row['name'];?></h6>
            ...
            <div class="p-1">
              <button type="button" id="view-more" class="btn btn-sm btn-info form-control text-center"  <?php echo $result["more"] ? "" : 'style="display: none;"'; ?>>
                View More
              </button>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div>
                    ...
                    <div style="float: right;" class="tumbler-wrapper">
                      <div class="tumbler"></div>
                      <div class="d-flex align-items-center h-100" onclick="setVisibleMode('light')">
                      ...
                      <div class="d-flex align-items-center h-100" onclick="setVisibleMode('dark')">
